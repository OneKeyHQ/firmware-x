...
if(NOT DEFINED ARM_LINUX_SYSLIB AND DEFINED GNU_MACHINE)
  set(ARM_LINUX_SYSLIB /usr/lib/${GNU_MACHINE}${FLOAT_ABI_SUFFIX})
endif()
...
list(APPEND CMAKE_FIND_ROOT_PATH  ${CMAKE_FIND_ROOT_PATH} ${ARM_LINUX_SYSROOT} ${ARM_LINUX_SYSLIB})
